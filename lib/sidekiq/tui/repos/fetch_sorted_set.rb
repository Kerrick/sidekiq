...
module Sidekiq
  module TUI
    # Include in a Fetch class that defines `call` to specify its Sidekiq
    # set class, Fetched message, and Record type.
    module FetchSortedSet
      def self.included(base)
        base.include Rooibos::Command::Custom
        base.include Sidekiq::Paginator
      ...
      def fetch_sorted_set(out, set_class, message_class, record_class)
        set = set_class.new
